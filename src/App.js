...
{concerts.length === 0 ? (
  <div style={{ 
    ...
    >
      ...
      <>
      {/* 🟢 NEW: THE INSPIRATION BRIDGE 
            Shows up until they hit 20 shows OR 5 files/artifacts */}
        {(headerStats.totalShows < 20 || headerStats.setlistCount < 5) && (
          <div style={{ 
            marginBottom: 30, 
            width: '100%', 
            display: 'flex', 
            ...
            <div style={{
              ...
              padding: '20px',
              background: `linear-gradient(135deg, ${hexToRgba(C.teal, 0.05)} 0%, ${hexToRgba(C.gold, 0.05)} 100%)`,
              border: `1px dashed ${C.border}`,
              borderRadius: 12,
              textAlign: 'center',
              boxShadow: `0 10px 30px rgba(0,0,0,0.2)`
            }}>
              <div style={{ fontFamily: "'Space Mono'", fontSize: 8, color: C.teal, letterSpacing: 3, fontWeight: 900, marginBottom: 10 }}>
                // CURATOR_VISION_ASSIST
              </div>
              <div style={{ fontFamily: "'Bebas Neue'", fontSize: '1.5rem', color: '#fff', lineHeight: 1.1, marginBottom: 12 }}>
                NEED INSPIRATION? SEE THE ARCHIVE <span style={{ color: C.gold }}>IN FULL EFFECT</span>
              </div>
              <button 
                onClick={() => handleNavigateToUser('eric')} // 🟢 Swap 'eric' with your actual username
                style={{
                  background: 'transparent',
  ...
  const VisionPortal = ({ onExplore }) => (
  <div className="fade-in" style={{
    marginTop: 30,
    padding: '25px',
    background: `linear-gradient(135deg, rgba(0, 229, 204, 0.05) 0%, rgba(157, 0, 255, 0.05) 100%)`,
    border: `1px solid ${C.border}`,
    borderRadius: 16,
    textAlign: 'center',
    maxWidth: 400,
    ...
    <div style={{ fontFamily: "'Space Mono'", fontSize: 9, color: C.teal, letterSpacing: 3, fontWeight: 900, marginBottom: 12 }}>
      // CURATOR_VISION_ENABLED
    </div>
    <div style={{ fontFamily: "'Bebas Neue'", fontSize: '1.8rem', color: '#fff', lineHeight: 1.1, marginBottom: 15 }}>
      SEE THE ARCHIVE <br/> <span style={{ color: C.gold }}>IN FULL EFFECT</span>
    </div>
    <p style={{ fontFamily: "'Space Mono'", fontSize: 8, color: C.gray, lineHeight: 1.6, marginBottom: 20 }}>
      New curators are encouraged to study existing collections to understand signal mapping and artifact curation.
    </p>
    <button 
      onClick={onExplore}
      style={{
